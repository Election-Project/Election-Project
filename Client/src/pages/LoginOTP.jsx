...
const LoginOTP = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-3xl bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl p-8 flex flex-col md:flex-row md:gap-8">
        ...
        <div className="w-full md:w-1/2">
          <img
            src="https://media.istockphoto.com/id/473162092/photo/ballot-box-with-national-flag-on-background-jordan.jpg?s=612x612&w=0&k=20&c=rk7WSg_jXdlYUtkOsMyu7aiGNJ5JKHyZ-GW1He4SBdE="
            alt="Voting"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500 opacity-90 sm:text-sm"
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
              إرسال OTP
            </button>
            ...
            <div className="text-center mt-4">
              <Link
                ...
                className="text-gray-600 hover:underline text-red-800 font-semibold"
              >
